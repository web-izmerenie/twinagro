...
$MESS['MF_AUTHOR_WORK_CITY']       = 'Город работы';
...
$MESS['MF_OK_MESSAGE']             = 'Спасибо, ваше обращение #TICKET_ID# принято.';
...
$MESS['FOUND_ERRORS_BEFORE_SEND']  = '1) Либо не указан в настройках компонента - Почтовый шаблоны для администратора;<br>
2) Либо вы настроили многосайтовость - в этом случае необходимо указать для почтовых шаблонов в админке привязку к сайту;<br>
3) Либо это ошибка работы функции mail() на сервере - в этом случае надо разбираться с хостингом;<br>
4) Либо модифицированы файлы модуля - в этом случае необходимо обращаться к разработчику Вашего сайта для поиска и исправления ошибки;<br>
О других случаях возникновения ошибки мне пока не известно, пишите мне на любой контактный e-mail.';
