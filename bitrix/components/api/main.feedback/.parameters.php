	...
	'PARAMETERS' => array(
		...
		"CUSTOM_FIELDS"               => Array(
			...
			"DEFAULT"  => Array(
				...
				6 => GetMessage('CUSTOM_FIELDS_VALUE_5'),
				7 => GetMessage('CUSTOM_FIELDS_VALUE_6'),
				8 => GetMessage('CUSTOM_FIELDS_VALUE_7'),
				9 => GetMessage('CUSTOM_FIELDS_VALUE_8'),
				10 => GetMessage('CUSTOM_FIELDS_VALUE_9'),
				11 => GetMessage('CUSTOM_FIELDS_VALUE_10'),
				12 => GetMessage('CUSTOM_FIELDS_VALUE_11'),
				13 => GetMessage('CUSTOM_FIELDS_VALUE_12'),
			),
		),
		'BRANCH_ACTIVE'               => Array(
